...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='describes',
            field=models.ManyToManyField(help_text='Historical individuals that this description refers to. If the agent is a group, this can be multiple individuals.', related_name='source_descriptions', to='person.person'),
        ),
        migrations.AddField(
            model_name='agentdescription',
            name='source',
