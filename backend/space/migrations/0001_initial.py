    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('identifiable', models.BooleanField(default=True, help_text='Whether this place is an identifiable location that can be cross-referenced between descriptions, or a generic description')),
                ('level', models.IntegerField(choices=[(0, 'settlement, population centre'), (1, 'road, square, crossroad'), (2, 'fortification'), (3, 'building'), (4, 'room'), (5, 'spot, object')])),
                ('contains', models.ManyToManyField(related_name='contained_in', to='space.structure')),
            ],
            options={
                'abstract': False,
            },
