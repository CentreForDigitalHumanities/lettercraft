 ...
 */
export const passwordValidators = [Validators.minLength(8)];
 ...
 */
export function identicalPasswordsValidator<T>(
    password1ControlName: string & T,
    password2ControlName: string & T,
): ValidatorFn {
